...
(async () => {
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/invert.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/invert-value.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/invert-saturation.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/invert-hue.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/invert-hueshift.png', encoded);
