...
(async () => {
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/font-1.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/font-2.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/font-3.png', encoded);
