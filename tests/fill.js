...
(async () => {
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/fill-static.png', encoded);
  ...
  }
  {
    ...
    if (process.env.OVERWRITE_TEST) await fs.writeFile('./tests/targets/fill-func.png', encoded);
